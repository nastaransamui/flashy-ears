...
const CollectionComponent: FC = (() => {
  ...
  const onOpen = (product: any, index: number) => {
    ...
    title.innerHTML = `${product[`product_label_${lang}`]} (${selectedColor[index][index]})`
    subtitle.innerHTML = product[`product_subtitle_${lang}`]
    price.innerHTML = product[`product__price`]
    description.innerHTML = product[`product__description_${lang}`]
                  ...
                  <div className={classes.grid__item} key={i.toString()}>
                    ...
                    <div ref={animeRef[i]} className={classes.product}>
                      ...
                      <p className={classes.product__description} >
                        {/* @ts-ignore */}
                        {product[`product__description_${lang}` as keyof typeof productItems]}
                      </p>
