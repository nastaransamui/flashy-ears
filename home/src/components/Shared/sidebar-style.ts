  ...
  (theme, _params, classes: any) => {
    ...
    return {
      ...
      nav: {
        ...
        top: 0,
        bottom: 0,
        borderRight: `50px solid ${theme.palette.secondary.main}`,
        cursor: 'pointer',
        WebkitTransition: 'all 600ms ease',
        MozTransition: 'all 600ms ease',
        msTransition: 'all 600ms ease',
      ...
      left: {
        ...
        backgroundImage: `url(/flags/128x128/${lang.toUpperCase()}.png)`,
      },
      center: {
        ...hoverClass,
        opacity: 1,
      ...
      lefter: {
        ...
        backgroundImage: `url(/images/Icons/${theme.palette.mode}.png)`,
      },
      righter: {
        ...hoverClass,
        transform: `translateX(60px) translateZ(-50px) rotateY(10deg)`,
